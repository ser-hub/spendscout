...
final class Version20240125135711 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE entry (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, tag_id INT NOT NULL, currency_id INT NOT NULL, name VARCHAR(255) DEFAULT NULL, is_expense TINYINT(1) NOT NULL, amount DOUBLE PRECISION NOT NULL, date DATE NOT NULL, INDEX IDX_2B219D70A76ED395 (user_id), INDEX IDX_2B219D70BAD26311 (tag_id), UNIQUE INDEX UNIQ_2B219D7038248176 (currency_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
